...
while (true)
{
    cout<<"option_1: inset at tail"<<endl; //done
    cout<<"option_2: print_limklist"<<endl;//done
    cout<<"option_3: insert_at_any"<<endl;//done
    cout<<"option_4: insert_head"<<endl; //done
    cout<<"option_5: delete_pos"<<endl; //done
    cout<<"option_6: delete_head"<<endl;//done
